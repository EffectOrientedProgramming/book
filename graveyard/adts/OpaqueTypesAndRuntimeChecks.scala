...
def run =
  ...
  // types at runtime
  /* name match case name: Info.Name =>
 ...
 * the types at runtime def
 * printNameRepo(nameRepo: Info.NameOrRepo) =
 * nameRepo match //case _: Info.NameOrRepo =>
 * println(s"name: $nameRepo") case name:
 * Info.Name => println(s"name: $name") case
 * repo: Info.Repo => println(s"repo: $repo")
 * //case _ => println(s"name = repo = ") //case
 * _: Info.NameAndRepo => println(s"name =
 * $nameRepo repo = ")
 *
 * printNameRepo(name) printNameRepo(repo) */
