...
//   eval = zio.ZIOCompanionVersionSpecific$$Lambda$15753/0x0000000103fb6440@7978758d
// )
```
...
// Stateful(repl.MdocSession.MdocApp.res2(08_Running_Effects.md:35),zio.FiberRef$unsafe$$anon$2$$Lambda$15795/0x0000000103ff5040@485a164b)
```
