...
//   eval = zio.ZIOCompanionVersionSpecific$$Lambda$16305/0x00000001041fb840@22717932
// )
```
...
// Stateful(repl.MdocSession.MdocApp.res2(08_Running_Effects.md:35),zio.FiberRef$unsafe$$anon$2$$Lambda$16411/0x00000001042ac040@c6d0fad)
```
