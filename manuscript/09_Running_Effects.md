...
//   eval = zio.ZIOCompanionVersionSpecific$$Lambda$15841/0x0000000803faa440@127701ce
// )
println("C")
// C
```
...
// Stateful(repl.MdocSession.MdocApp.res3(09_Running_Effects.md:25),zio.FiberRef$unsafe$$anon$2$$Lambda$15918/0x0000000804041040@43b021df)
```
