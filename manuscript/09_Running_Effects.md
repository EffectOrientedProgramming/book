...
//   eval = zio.ZIOCompanionVersionSpecific$$Lambda$17459/0x0000000104588040@62353fd9
// )
println("C")
// C
```
...
// Stateful(repl.MdocSession.MdocApp.res3(09_Running_Effects.md:25),zio.FiberRef$unsafe$$anon$2$$Lambda$17526/0x000000010460a840@3952edcf)
```
