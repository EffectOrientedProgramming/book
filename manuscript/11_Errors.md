...
// 	at repl.MdocSession$MdocApp.$init$$$anonfun$4$$anonfun$1(11_Errors.md:31)
...
// 		at repl.MdocSession$MdocApp.$init$$$anonfun$4$$anonfun$1(11_Errors.md:32)
// 		at mdoctools.OurConsole$.printLine$$anonfun$1(OurConsole.scala:18)
// 		at scala.runtime.function.JProcedure1.apply(JProcedure1.java:15)
// 		at scala.runtime.function.JProcedure1.apply(JProcedure1.java:10)
// 		at zio.UnsafeVersionSpecific.implicitFunctionIsFunction$$anonfun$1(UnsafeVersionSpecific.scala:27)
...
// 		at repl.MdocSession$MdocApp.$init$$$anonfun$4$$anonfun$1(11_Errors.md:33)
// 		at mdoctools.OurConsole$.printLine$$anonfun$1(OurConsole.scala:18)
// 		at scala.runtime.function.JProcedure1.apply(JProcedure1.java:15)
// 		at scala.runtime.function.JProcedure1.apply(JProcedure1.java:10)
// 		at zio.UnsafeVersionSpecific.implicitFunctionIsFunction$$anonfun$1(UnsafeVersionSpecific.scala:27)
...
// res3: String = "Temperature: 35 degrees"
```
...
// 	at repl.MdocSession$MdocApp.displayTemperature(11_Errors.md:74)
// 	at repl.MdocSession$MdocApp.currentTemperatureUnsafe(11_Errors.md:84)
// 	at repl.MdocSession$MdocApp.$init$$$anonfun$6(11_Errors.md:95)
```
...
## Edit This Chapter
[Edit This Chapter](https://github.com/EffectOrientedProgramming/book/edit/main/Chapters/11_Errors.md)
