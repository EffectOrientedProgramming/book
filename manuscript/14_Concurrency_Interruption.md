...
// About to sleep forever
// Interrupted the eternal sleep
// zio.internal.FiberRuntime@1077d182
```
...
runDemo:
  defer:
    ZIO
      ...
      .debug("Time:")
      .run
// Time:: (PT0.000501997S,Some(**TODO**))
// (PT0.000501997S,Some(**TODO**))
```
...
## Edit This Chapter
[Edit This Chapter](https://github.com/EffectOrientedProgramming/book/edit/main/Chapters/14_Concurrency_Interruption.md)
