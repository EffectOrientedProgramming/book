...
// Result: Temperature: Unavailable
```
...
//   trace = "repl.MdocSession.MdocApp.<local MdocApp>.getTemperatureZ(06_Errors.md:218)",
//   first = GenerateStackTrace(
//     trace = "repl.MdocSession.MdocApp.<local MdocApp>.getTemperatureZ(06_Errors.md:218)"
//   ),
//   successK = zio.ZIO$$$Lambda$15388/0x0000000803e5f040@3abfe53f
// )
