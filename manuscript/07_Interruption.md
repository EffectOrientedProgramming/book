...
[Edit This Chapter](https://github.com/EffectOrientedProgramming/book/edit/main/Chapters/07_Interruption.md)
...
// About to sleep forever
// Interrupted the eternal sleep
// Result: zio.internal.FiberRuntime@7da63730
```
...
runDemo:
  defer:
    ZIO
      ...
      .debug("Time:")
      .run
// Result: (PT0.000622478S,Some(**TODO**))
```
