...
//   eval = zio.ZIOCompanionVersionSpecific$$Lambda$14581/0x0000000103cc4440@327a8efb
// )
```
...
// Stateful(repl.MdocSession.MdocApp.res2(06_Running_Effects.md:35),zio.FiberRef$unsafe$$anon$2$$Lambda$14658/0x0000000103d2c840@1a67898b)
```
