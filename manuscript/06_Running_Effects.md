...
//   eval = zio.ZIOCompanionVersionSpecific$$Lambda$15742/0x0000000103fb4840@3209f92c
// )
```
...
// Stateful(repl.MdocSession.MdocApp.res2(06_Running_Effects.md:35),zio.FiberRef$unsafe$$anon$2$$Lambda$15775/0x0000000103ff4040@3a2821a2)
```
