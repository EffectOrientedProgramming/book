...
// Heads
// + flips 10 times
// Result: Success(Summary(1,0,0,,PT0.283803S))
```
...
// Result: Success(Summary(1,0,0,,PT0.044717S))
```
...
// R: Heads
// + flaky plan
// Result: Success(Summary(1,0,0,,PT0.031363S))
```
...
// Result: Success(Summary(1,0,0,,PT0.024687S))
```
