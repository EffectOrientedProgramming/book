...
// Num Heads = 10
// + flips 10 times
// Result: Summary(1,0,0,,PT0.048887S)
```
...
// R: Heads
// + rosencrantzAndGuildensternAreDead finishes
// Result: Summary(1,0,0,,PT0.042041S)
```
...
// *Performance Begins*
// Tails
// <FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-641994843":
...
// R: Heads
// + flaky plan
// Result: Summary(1,0,0,,PT0.031578S)
```
...
// Result: Summary(1,0,0,,PT0.049245S)
```
