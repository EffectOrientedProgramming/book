...
Num Heads = 10
+ flips 10 times
Result: Summary(1,0,0,,PT0.03369S)
```
...
R: Heads
+ rosencrantzAndGuildensternAreDead finishes
Result: Summary(1,0,0,,PT0.038315S)
```
...
*Performance Begins*
Tails
<FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-877736670":
...
R: Heads
+ flaky plan
Result: Summary(1,0,0,,PT0.022013S)
```
...
Result: Summary(1,0,0,,PT0.029546S)
```
