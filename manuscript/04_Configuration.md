...
def run =
  flipTen
// <FAIL> Fail(Tails,Stack trace for thread "zio-fiber-200371":
...
// Heads
// + flips 10 times
// Result: Summary(1,0,0,,PT0.257851S)
```
...
// Result: Summary(1,0,0,,PT0.112369S)
```
...
// *Performance Begins*
// <FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-224839":
// 	at repl.MdocSession.MdocApp.coinToss(<input>:395)
...
// R: Heads
// + flaky plan
// Result: Summary(1,0,0,,PT0.054179S)
```
...
// Result: Summary(1,0,0,,PT0.028474S)
```
