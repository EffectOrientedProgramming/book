...
// Num Heads = 10
// + flips 10 times
// Result: Summary(1,0,0,,PT0.053512S)
```
...
// R: Heads
// + rosencrantzAndGuildensternAreDead finishes
// Result: Summary(1,0,0,,PT0.048739S)
```
...
// *Performance Begins*
// Tails
// <FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-859592611":
...
// R: Heads
// + flaky plan
// Result: Summary(1,0,0,,PT0.01951S)
```
...
// Result: Summary(1,0,0,,PT0.019647S)
```
