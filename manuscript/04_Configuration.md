...
Num Heads = 10
+ flips 10 times
Result: Summary(1,0,0,,PT0.034328S)
```
...
R: Heads
+ rosencrantzAndGuildensternAreDead finishes
Result: Summary(1,0,0,,PT0.045881S)
```
...
*Performance Begins*
Tails
<FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-936836427":
...
R: Heads
+ flaky plan
Result: Summary(1,0,0,,PT0.025205S)
```
...
Result: Summary(1,0,0,,PT0.022703S)
```
