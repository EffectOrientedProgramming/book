...
// Num Heads = 10
// + flips 10 times
// Result: Summary(1,0,0,,PT0.061841S)
```
...
// R: Heads
// + rosencrantzAndGuildensternAreDead finishes
// Result: Summary(1,0,0,,PT0.036707S)
```
...
// *Performance Begins*
// Tails
// <FAIL> R: Fail(Tails,Stack trace for thread "zio-fiber-1448022451":
...
// R: Heads
// + flaky plan
// Result: Summary(1,0,0,,PT0.025527S)
```
...
// Result: Summary(1,0,0,,PT0.040692S)
```
