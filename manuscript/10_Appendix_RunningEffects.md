...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.025606S)
```
...
Result: Summary(1,0,0,,PT0.021563S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1426269066" scala.NotImplementedError: an implementation is missing
