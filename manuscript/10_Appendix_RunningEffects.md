...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.039145S)
```
...
Result: Summary(1,0,0,,PT0.025474S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1392017738" scala.NotImplementedError: an implementation is missing
