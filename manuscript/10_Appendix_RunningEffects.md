  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.334974S)
```
...
// Result: Summary(1,0,0,,PT0.147514S)
```
...
// - console works
//   Exception in thread "zio-fiber-1506631250" scala.NotImplementedError: an implementation is missing
