...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.043982S)
```
...
Result: Summary(1,0,0,,PT0.031059S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-2023030784" scala.NotImplementedError: an implementation is missing
