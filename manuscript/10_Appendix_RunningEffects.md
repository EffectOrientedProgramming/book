...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.028032S)
```
...
Result: Summary(1,0,0,,PT0.024989S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1566890633" scala.NotImplementedError: an implementation is missing
