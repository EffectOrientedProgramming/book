...
Log: Signup initiated for Morty
+ random is random
Result: Summary(1,0,0,,PT0.382679S)
```
...
Result: Summary(1,0,0,,PT0.077817S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1396780434" scala.NotImplementedError: an implementation is missing
