...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.316907S)
```
...
Result: Summary(1,0,0,,PT0.123539S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-53767912" scala.NotImplementedError: an implementation is missing
