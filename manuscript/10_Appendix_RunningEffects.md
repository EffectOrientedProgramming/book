  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.455835S)
```
...
// Result: Summary(1,0,0,,PT0.097158S)
```
...
// - console works
//   Exception in thread "zio-fiber-486173374" scala.NotImplementedError: an implementation is missing
