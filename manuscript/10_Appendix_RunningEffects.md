...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.380739S)
```
...
Result: Summary(1,0,0,,PT0.086176S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-133020958" scala.NotImplementedError: an implementation is missing
