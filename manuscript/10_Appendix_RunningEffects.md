...
+ random is random
Result: Summary(1,0,0,,PT0.304317S)
```
...
Result: Summary(1,0,0,,PT0.122171S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1259804312" scala.NotImplementedError: an implementation is missing
