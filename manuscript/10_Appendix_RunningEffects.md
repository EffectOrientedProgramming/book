  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.37243S)
```
...
// Result: Summary(1,0,0,,PT0.094952S)
```
...
// - console works
//   Exception in thread "zio-fiber-658869377" scala.NotImplementedError: an implementation is missing
