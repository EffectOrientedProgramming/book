  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.459496S)
```
...
// Result: Summary(1,0,0,,PT0.110616S)
```
...
// - console works
//   Exception in thread "zio-fiber-660959143" scala.NotImplementedError: an implementation is missing
