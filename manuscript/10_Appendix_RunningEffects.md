  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.384009S)
```
...
// Result: Summary(1,0,0,,PT0.064182S)
```
...
// - console works
//   Exception in thread "zio-fiber-84285" scala.NotImplementedError: an implementation is missing
