...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.38015S)
```
...
Result: Summary(1,0,0,,PT0.112072S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-688944592" scala.NotImplementedError: an implementation is missing
