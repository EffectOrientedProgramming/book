...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.450911S)
```
...
Result: Summary(1,0,0,,PT0.105263S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-917534092" scala.NotImplementedError: an implementation is missing
