  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.35129S)
```
...
// Result: Summary(1,0,0,,PT0.058944S)
```
...
// - console works
//   Exception in thread "zio-fiber-1496699035" scala.NotImplementedError: an implementation is missing
