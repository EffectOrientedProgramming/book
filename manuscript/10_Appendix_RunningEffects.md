...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.424325S)
```
...
Result: Summary(1,0,0,,PT0.054621S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-416160911" scala.NotImplementedError: an implementation is missing
