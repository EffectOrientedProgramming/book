...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.376434S)
```
...
Result: Summary(1,0,0,,PT0.053711S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-888229189" scala.NotImplementedError: an implementation is missing
