  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.360913S)
```
...
// Result: Summary(1,0,0,,PT0.088868S)
```
...
// - console works
//   Exception in thread "zio-fiber-496129640" scala.NotImplementedError: an implementation is missing
