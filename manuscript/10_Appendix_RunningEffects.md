...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.03168S)
```
...
Result: Summary(1,0,0,,PT0.024976S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1584897383" scala.NotImplementedError: an implementation is missing
