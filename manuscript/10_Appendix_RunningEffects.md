...
Log: Signup initiated for Morty
+ random is random
Result: Summary(1,0,0,,PT0.428326S)
```
...
Result: Summary(1,0,0,,PT0.085665S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-197004128" scala.NotImplementedError: an implementation is missing
