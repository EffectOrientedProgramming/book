  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.403206S)
```
...
// Result: Summary(1,0,0,,PT0.117016S)
```
...
// - console works
//   Exception in thread "zio-fiber-947741449" scala.NotImplementedError: an implementation is missing
