  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.303819S)
```
...
// Result: Summary(1,0,0,,PT0.092605S)
```
...
// - console works
//   Exception in thread "zio-fiber-1522457062" scala.NotImplementedError: an implementation is missing
