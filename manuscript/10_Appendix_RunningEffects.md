  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.433549S)
```
...
// Result: Summary(1,0,0,,PT0.105023S)
```
...
// - console works
//   Exception in thread "zio-fiber-257549523" scala.NotImplementedError: an implementation is missing
