  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.422041S)
```
...
// Result: Summary(1,0,0,,PT0.080239S)
```
...
// - console works
//   Exception in thread "zio-fiber-1623671567" scala.NotImplementedError: an implementation is missing
