...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.323924S)
```
...
Result: Summary(1,0,0,,PT0.084001S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-432505737" scala.NotImplementedError: an implementation is missing
