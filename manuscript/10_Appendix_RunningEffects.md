  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.38875S)
```
...
// Result: Summary(1,0,0,,PT0.07013S)
```
...
// - console works
//   Exception in thread "zio-fiber-2060205252" scala.NotImplementedError: an implementation is missing
