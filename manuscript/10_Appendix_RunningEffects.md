...
Log: Signup initiated for Morty
+ random is random
Result: Summary(1,0,0,,PT0.35216S)
```
...
Result: Summary(1,0,0,,PT0.093243S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-131881761" scala.NotImplementedError: an implementation is missing
