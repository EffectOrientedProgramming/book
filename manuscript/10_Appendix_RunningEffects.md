  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.439552S)
```
...
// Result: Summary(1,0,0,,PT0.086073S)
```
...
// - console works
//   Exception in thread "zio-fiber-11424484" scala.NotImplementedError: an implementation is missing
