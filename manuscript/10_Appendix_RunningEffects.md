  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.368226S)
```
...
// Result: Summary(1,0,0,,PT0.07871S)
```
...
// - console works
//   Exception in thread "zio-fiber-274641937" scala.NotImplementedError: an implementation is missing
