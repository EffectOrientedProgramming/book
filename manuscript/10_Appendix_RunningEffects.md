...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.403277S)
```
...
Result: Summary(1,0,0,,PT0.164209S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-227092537" scala.NotImplementedError: an implementation is missing
