  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.32186S)
```
...
// Result: Summary(1,0,0,,PT0.079054S)
```
...
// - console works
//   Exception in thread "zio-fiber-83013128" scala.NotImplementedError: an implementation is missing
