  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.511326S)
```
...
// Result: Summary(1,0,0,,PT0.090277S)
```
...
// - console works
//   Exception in thread "zio-fiber-796874768" scala.NotImplementedError: an implementation is missing
