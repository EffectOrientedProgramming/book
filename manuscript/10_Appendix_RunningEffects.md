  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.350565S)
```
...
// Result: Summary(1,0,0,,PT0.080839S)
```
...
// - console works
//   Exception in thread "zio-fiber-1829371198" scala.NotImplementedError: an implementation is missing
