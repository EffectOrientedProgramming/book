...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.335569S)
```
...
Result: Summary(1,0,0,,PT0.161954S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-165322184" scala.NotImplementedError: an implementation is missing
