...
Log: Signup initiated for Morty
+ random is random
Result: Summary(1,0,0,,PT0.394115S)
```
...
Result: Summary(1,0,0,,PT0.094926S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-916601045" scala.NotImplementedError: an implementation is missing
