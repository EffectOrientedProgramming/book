  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.393686S)
```
...
// Result: Summary(1,0,0,,PT0.058205S)
```
...
// - console works
//   Exception in thread "zio-fiber-2001768192" scala.NotImplementedError: an implementation is missing
