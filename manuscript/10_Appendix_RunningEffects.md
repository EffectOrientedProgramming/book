  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.403614S)
```
...
// Result: Summary(1,0,0,,PT0.086471S)
```
...
// - console works
//   Exception in thread "zio-fiber-783459685" scala.NotImplementedError: an implementation is missing
