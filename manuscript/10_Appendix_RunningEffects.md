  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.324579S)
```
...
// Result: Summary(1,0,0,,PT0.081213S)
```
...
// - console works
//   Exception in thread "zio-fiber-240267658" scala.NotImplementedError: an implementation is missing
