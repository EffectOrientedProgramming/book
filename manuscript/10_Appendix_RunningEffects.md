...
test("random is random"):
  defer:
    assertTrue:
      Random.nextIntBounded(10).run < 10
// spec50: ToTest[Nothing, Nothing] = mdoctools.ToTest@3c83e4b
// Result: Test PASSED
```
...
// spec56: ToTest[Nothing, Nothing] = mdoctools.ToTest@9352f58
// Result: Test PASSED
```
...
// spec70: ToTest[Nothing, Nothing] = mdoctools.ToTest@3f1522e
// Result: Test PASSED
```
