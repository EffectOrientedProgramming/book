...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.280393S)
```
...
Result: Summary(1,0,0,,PT0.111635S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-757482241" scala.NotImplementedError: an implementation is missing
