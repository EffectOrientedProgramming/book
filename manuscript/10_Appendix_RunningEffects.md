...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.372884S)
```
...
Result: Summary(1,0,0,,PT0.076459S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-793013319" scala.NotImplementedError: an implementation is missing
