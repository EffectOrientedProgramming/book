...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.428601S)
```
...
Result: Summary(1,0,0,,PT0.081797S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1225832773" scala.NotImplementedError: an implementation is missing
