  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.442237S)
```
...
// Result: Summary(1,0,0,,PT0.087782S)
```
...
// - console works
//   Exception in thread "zio-fiber-1377593668" scala.NotImplementedError: an implementation is missing
