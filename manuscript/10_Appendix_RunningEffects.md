  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.438331S)
```
...
// Result: Summary(1,0,0,,PT0.136154S)
```
...
// - console works
//   Exception in thread "zio-fiber-2103044010" scala.NotImplementedError: an implementation is missing
