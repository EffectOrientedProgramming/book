...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.35852S)
```
...
Result: Summary(1,0,0,,PT0.083721S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1386889147" scala.NotImplementedError: an implementation is missing
