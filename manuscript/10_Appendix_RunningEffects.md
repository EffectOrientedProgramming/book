  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.40998S)
```
...
// Result: Summary(1,0,0,,PT0.096256S)
```
...
// - console works
//   Exception in thread "zio-fiber-1502409499" scala.NotImplementedError: an implementation is missing
