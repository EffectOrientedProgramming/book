...
Log: Signup initiated for Morty
+ random is random
Result: Summary(1,0,0,,PT0.359659S)
```
...
Result: Summary(1,0,0,,PT0.077333S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1124969921" scala.NotImplementedError: an implementation is missing
