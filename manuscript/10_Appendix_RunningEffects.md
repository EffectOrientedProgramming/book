...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.45793S)
```
...
Result: Summary(1,0,0,,PT0.113022S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-623900825" scala.NotImplementedError: an implementation is missing
