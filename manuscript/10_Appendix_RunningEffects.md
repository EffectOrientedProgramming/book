...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.556861S)
```
...
Result: Summary(1,0,0,,PT0.097985S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-179163054" scala.NotImplementedError: an implementation is missing
