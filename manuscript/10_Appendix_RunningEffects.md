  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.413973S)
```
...
// Result: Summary(1,0,0,,PT0.108879S)
```
...
// - console works
//   Exception in thread "zio-fiber-861410208" scala.NotImplementedError: an implementation is missing
