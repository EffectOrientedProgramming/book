  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.393055S)
```
...
// Result: Summary(1,0,0,,PT0.10266S)
```
...
// - console works
//   Exception in thread "zio-fiber-185770077" scala.NotImplementedError: an implementation is missing
