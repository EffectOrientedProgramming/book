...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.031403S)
```
...
Result: Summary(1,0,0,,PT0.025231S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-359170014" scala.NotImplementedError: an implementation is missing
