...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.429583S)
```
...
Result: Summary(1,0,0,,PT0.078573S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-533600946" scala.NotImplementedError: an implementation is missing
