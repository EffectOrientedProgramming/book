  ...
  test("random is random"):
    defer:
      assertTrue:
        Random.nextIntBounded(10).run < 10
// + random is random
// Result: Summary(1,0,0,,PT0.310794S)
```
...
// Result: Summary(1,0,0,,PT0.074921S)
```
...
// - console works
//   Exception in thread "zio-fiber-1073009395" scala.NotImplementedError: an implementation is missing
