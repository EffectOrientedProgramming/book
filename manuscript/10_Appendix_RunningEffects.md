...
```shell
+ random is random
Result: Summary(1,0,0,,PT0.030044S)
```
...
Result: Summary(1,0,0,,PT0.028487S)
```
...
```shell
- console works
  Exception in thread "zio-fiber-1939381391" scala.NotImplementedError: an implementation is missing
