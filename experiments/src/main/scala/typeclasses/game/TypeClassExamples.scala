...
// }
// import
// typeclasses.game.interactions.Interactive
...
// "could not find a Drawable for character: " +
//            input
//        )
//      )
//
//  /* def parseGrid(fullBoardRepresentation:
//   * String, availableDrawables: List
//   * [Drawable[_]] ): Board =
//   * Board( fullBoardRepresentation.split("\n")
//   * .map( row => row.map{symbol => // TODO
//   * Figure out how to avoid implicit implicit
//   * val drawable = parseCharacter(symbol,
//   * availableDrawables) val instance =
//   * drawable.constructor() Cell(instance)
//   * }.toVector ).toVector ) */
//
...
//
// import
// typeclasses.game.given_FullInteractions_Hero_SupEnt
...
//
// //
// println(renderBoard(parseGrid(startingState,
//    // allDrawables)))
//
//    println(
//      renderBoard(
