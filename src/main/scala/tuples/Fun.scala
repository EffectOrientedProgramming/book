...
def fun() =
  ...
  // single value tuples are really just the value, no reason to treat it as a tuple
  // Q: is there a way to define single element tuples?
  val t1: (String) = ("asdf")
  assert(t1 == "asdf")
  ...
  val t2_0 = t2.drop(1)
  //val t2_0: Int *: scala.Tuple$package.EmptyTuple.type = t2.drop(1)
  //assert(t2_0._1 == "asdf")
